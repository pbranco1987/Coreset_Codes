...
def main() -> int:
    ...
    _k_info = {
        "R0": "k: 50-500, quota computation",
        "R1": "k: 50-500, 3-obj NSGA-II (SKL+MMD+SD)",
        "R2": "k=100, geography ablation (no quota)",
        "R3": "k=100, ablation -SKL",
        "R4": "k=100, ablation -MMD",
        "R5": "k=100, ablation -Sinkhorn",
        "R6": "k=100, baselines",
        "R7": "k=100, diagnostics",
        "R8": "k=100, PCA space",
        "R9": "k=100, raw space",
        "R10": "k=100, no constraints",
        "R11": "k=100, quota only",
